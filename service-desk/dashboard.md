...
완료율: **71%** · 요청 7건 · 진행중 0건 · 완료 6건 (Confirmed 5)

| ID | Date | Subject | Status |
|---|---|---|---|
| 0001 | 2026.07.12 | 01문서에 Fre, Pro, Max의 차이점을 간단하게 기술 | Confirmed |
...
| 0007 | 2026.07.12 | 폴더 이동 방식 대신 상태값만으로 요청을 관리하도록 구조 변경 | Completed |
